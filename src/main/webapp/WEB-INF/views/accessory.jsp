...
<div class="container well" style="width: 500px;">
    <blockquote align="center" style="color:purple;">Post details about the Accessories below</blockquote>
   
    <form action="<c:url value="/accessories_form"/>">
        ...
        <div class="form-group">
            <label>Type of Accessories </label><br>
           <input type="text" name="accessories_type"  class="form-control"/>                        
        </div>
        <div class="form-group">
